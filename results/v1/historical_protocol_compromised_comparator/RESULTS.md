...
The detailed historical leaderboard, metrics, manifest, and figures are retained below this directory so they cannot be mistaken for the active Diana-H3P result surface; their original numerical content is unchanged. The source remains under `model/joint_bayes_personalizer/`. Active results are generated under `results/v1/diana_h3p/`.
